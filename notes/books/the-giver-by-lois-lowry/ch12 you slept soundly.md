...
# 12. You Slept Soundly

## 本章导航

- **一句话概括**：Jonas 第一次在早餐桌上对家人撒谎（说自己睡得很好）；Fiona 在他面前发生了"seeing beyond"事件；Jonas 第一次问 The Giver 关于 seeing beyond 的问题。
- **情感弧线位置**：记忆传递后的第一天——Jonas 开始在日常生活中"看见更多"；他与社区的距离感增加；谎言的开始；Fiona 的 seeing beyond 暗示她也有特殊能力。
- **Tropes 兑现/反转**：Jonas 的第一次谎言（对你撒谎）；seeing beyond 越来越频繁；Fiona 也有 pale eyes 的暗示；社区对 Receiver 训练内容的一无所知。
- **人物弧线**：Jonas 对撒谎的新态度（"not ready to lie, not willing to tell the truth"）；Fiona 的能力第一次被 Jonas 感知到；The Giver 对 Jonas 问题的好奇。
- **叙事手法**：家庭早餐场景的日常性与谎言的颠覆性形成对照；Fiona 的头发"变化"事件；Jonas 的意识流式反思。
...
- **读者视角提示**：Fiona 的 pale eyes 在第3章就已经被提及——现在这个细节有了新的意义。
