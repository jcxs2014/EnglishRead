...
# 09. Now for the First Time

## 本章导航

- **一句话概括**：Jonas 回到家的第一个晚上，收到了一份几乎空白的指令清单——他被允许提问、被禁止讨论训练、被禁止做梦、被禁止服药、被禁止申请释放、被允许撒谎。
- **情感弧线位置**：高潮后的消化——Jonas 在震惊中阅读规则，慢慢理解自己命运的重量；他对社区的认知在一天之内被彻底颠覆。
- **Tropes 兑现/反转**：规则清单（Rules 1-8）；"You may lie"的全社区含义；父母不知道被选中的女孩的命运；Gabriel 的名字第一次被正式使用。
- **人物弧线**：Jonas 对"许可"与"禁止"的重新理解；父母对 Receiver 角色的敬畏与无知；Jonas 对父母是否也收到"You may lie"指令的恐惧。
- **叙事手法**：规则的清单式呈现；家庭对话的日常性与内容的颠覆性形成对照；Jonas 的意识流式反思。
...
- **读者视角提示**：Jonas 的最后一个想法是：如果所有成人在十二岁时都被告知"你可以撒谎"——那他们的"精确语言"还有意义吗？这个想法让他崩溃。
