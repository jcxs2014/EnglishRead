...
**中文理解**：作者把“拒绝、行动控制与打破循环”写成第二人称行动建议，要求读者直接做一件事，而不是只表示赞成。（本句关键词：Wоrk）

**句子结构**：祈使句省略主语并直接使用动词 Wоrk，把行动责任交给听话者。 本句关键词为 Wоrk，可在引语中逐字回查。

**关键词**：Wоrk、thеу、negatively。

**表达方式**：祈使语气把抽象价值转成读者能立即尝试的步骤。 关键词 Wоrk 提供了回原文核对的抓手。

**为什么这样写**：它把价值判断转成行为选择；Wоrk 是建议的落点，但现实安全、资源和他人同意仍需另行核对。
...
**中文理解**：作者在说明“拒绝、行动控制与打破循环”时给出一个明确判断或行动方向；That 是这段论述中可直接追踪的支点。（本句关键词：That）
...
**表达方式**：这种句式把作者的判断和论证推进放在同一行。 关键词 That 提供了回原文核对的抓手。
