...
- **出处**：Kim Choyeop《If We Cannot Go at the Speed of Light》第 2 篇
- **体裁**：思辨科幻中短篇，约 39,700 字符 / 147 段
- **一句话主题**：祖母 Heejin 在外星流落十年（地球已过四十年），与一个用**颜色**而非声音表意的智慧物种共处，回到地球后终生坚称自己完成了首次接触，却至死拒绝透露那颗星球的坐标——她保护的不是秘密，是那个族群。

## 叙事结构

| 部分 | 内容 | 功能 |
|---|---|---|
| I | 孙女视角：祖母的照片、失踪、四十年后被救回 | 用后代的追述框定全篇 |
| II | 世界的官方"首次接触"：外星文明拒绝往来、击毁所有靠近的飞船 | 建立对照——被拒绝的接触 |
| III | 祖母坚称自己先完成了接触，但拒绝提供任何证据 | 制造不可信叙述者的表象 |
| IV | 倒叙：Heejin 坠落、独自求生、遇见"他们" | 真相开始 |
| V | 与 Luui 一族共处、语言/颜色的沟通、代际传承 | 主题核心 |
| VI | 返回地球后的沉默 | 沉默即保护 |

## 核心概念

- **时间膨胀**：地球过了 40 年，Heejin 只过了 10 年——相对论不是设定装饰，是这篇的情感机制
- **Louey**：救下 Heejin 的个体的名字，也成为她对这个物种的称呼；后文揭示 Louey 是**世代相传的角色名**
- **对照结构**：官方"首次接触"以毁灭告终；祖母的私人接触以共生告终——区别在于**是否试图占有**
- **拒绝作证**：祖母终生不说坐标，被世界当作疯子——这是她为保护 Louey 一族付出的代价
...
> "The mystery was no longer if there was other intelligence in the universe but why they wanted us to stay away from them."

> "I was the one who made first contact."
...
- 中文理解：最终，祖母被当成这样一个女人：独自在太空漂流四十年、疯了一半，最后连自己的谎话都信了。
- 句子结构：was treated like a woman → 两个并列 who 从句（who had drifted … and gone half-mad / who eventually started to believe）。
- 关键词：**gone half-mad**（疯了一半——留半分体面的贬低）；**believe her own lies**（相信自己的谎言——最彻底的否定形式）
- 表达方式：世界对她的判决被压缩成一个长定语。注意句子不说"人们认为"，而说 was treated like——**待遇比看法更伤人**。
- 为什么这样写：读者此时已经知道（或即将知道）她说的是真的。这句的功能是让读者站在真相一侧，看着一个诚实的人被合理地误解——因为她自己选择了不辩解。
...
**⑧** "Did the awareness of one's lonely place in the vast universe and the desire to make contact with another civilization require a more advanced form of intelligence?"
...
- 读者视角提示：把这句和⑧对读——Heejin 用"是否渴望接触"衡量智慧，同时她身边正发生着一场不依赖语言的、成功的接触。
...
- 读者视角提示：⑤埋下的 **her first Louey** 在此兑现。Louey 是一个会被下一个人继承的名字，而这意味着 Heejin 将不止一次经历这一刻。
...
| 词/短语 | 释义 | 原文例句 |
|---|---|---|
| photon-propulsion | 光子推进 | "a small spaceship equipped with an ultralight photon-propulsion system" |
| folded spacetime | 折叠时空 | "ferry people across immense distances through folded spacetime" |
| extraterrestrial | 地球外的 | "the extraterrestrial leg of the effort" |
| obliterating | 彻底毁灭 | "by obliterating every Earth spaceship that attempted to approach" |
| sentient | 有感知/有意识的 | "clear evidence of sentient intelligence" |
| delusional | 妄想的 | "She was treated as delusional at first." |
| steadfast | 坚定不移的 | "in the face of her steadfast refusal to present facts" |
| malnourished | 营养不良的 | "extremely malnourished and with failing cognitive abilities" |
| demarcated | 划界的 | "each zone demarcated by a loose, soft line" |
| representational | 具象的（艺术） | "They didn't seem to be representational" |
| ideograms | 表意文字 | "she found nothing that resembled letters or ideograms" |
| elusive | 难以寻获的 | "But the shuttle remained elusive." |
| flightworthy | 适航的 | "it was unlikely it would be in a flightworthy state" |
| forays | 短途外出/突袭 | "She continued to follow them in their forays during the day" |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 原文例句 |
|---|---|---|
| abuzz with | 因……而喧腾 | "the world was already abuzz with previous discoveries" |
| pinky-swore | 拉钩发誓 | "Grandmother pinky-swore that she would return" |
| adrift | 漂流的 | "adrift inside an emergency shuttle" |
| stalling | 拖延 | "after much stalling, they admitted to faults" |
| cowered | 蜷缩躲避 | "Someone had come between it and her as she cowered" |
| ravine | 深谷 | "LOUEY TOOK HEEJIN INTO a deep ravine." |
| intimidated | 使人畏怯 | "Just to stand next to one of them intimidated her." |
| prying | 窥探 | "wordlessly discouraged her from prying further" |
| satiated | 吃饱满足的 | "Satiated for the first time since the crash landing" |
| taunted | 讥讽/挑弄 | "the five moons … taunted her attempts at self-delusion" |
| barrage | 连续轰击（此处指信息轰炸） | "she lived under a constant barrage of alien-related content" |
| exoskeletons | 外骨骼 | "Alien characters with glittery exoskeletons" |
| snares | 陷套 | "there were some complex snares made from plant stems" |
| omen | 兆头 | "this time, it was not a good omen" |

### ⭐ 基础

| 词/短语 | 释义 | 原文例句 |
|---|---|---|
| space suit | 太空服 | "She wore a white space suit with a helmet" |
| orbit | 轨道 | "Not long after it left orbit, the spacecraft completely vanished." |
| first contact | 首次接触 | "Earth had finally made first contact with an alien intelligence" |
| beacon | 信标 | "She needed it to track the beacon of the shuttle." |
| distress signal | 求救信号 | "she wouldn't be able to activate a distress signal to Earth" |
| bipedal | 双足的 | "Bipedal, limbed people." |
| animal hide | 兽皮 | "wore garments seemingly fashioned from animal hide" |
| dyes | 染料/颜料 | "the tools lay scattered around them, and dyes ran down to the floor" |

## 一句话总结

**祖母用四十年的疯名换 Louey 一族的安宁——这篇把"首次接触"从人类的功勋改写成对方的风险，而真正的沟通既不发生在语言里，也不发生在证据里，只发生在一只学会放轻力气的手上。**
