...
# 29. Audibility, Credibility, Consequence · Chapter 3（可听性、可信度、后果·第三章）

## 概览

- **出处**：*Recollections of My Nonexistence* (Viking, 2020)，Part VIII "Audibility, Credibility, Consequence" 第三章
- **作者**：Rebecca Solnit
- **章节定位**：全书第 29 章；从"希望"转向"男人向我解释事情"——那篇改变她一生的文章的诞生
- **字符数**：9760
- **一句话主旨**：以"在那些日子，我经常用天气报告作为给蒂娜的电子邮件的开头"开篇，探讨《男人向我解释事情》这篇散文的起源——它如何从一个笑话变成一篇改变她一生的文章，以及它如何成为一场全球运动的催化剂

### 论证脉络

Solnit 以"In those days I often headed my emails to Tina with weather reports"开篇，将"电子邮件"定义为一种"日常"——不是"写作"，而是"日常"。核心论点：《男人向我解释事情》这篇散文的起源不是"天才的灵光一现"，而是"日常的积累"——它是她与朋友之间的一个笑话，一次晚餐桌上的话题，直到她的朋友玛丽娜敦促她"写下来"。章末回到"你不知道你写的东西会产生什么影响"——写作的影响不是"可预测"的，而是"不可预测"的。

### 结构

| 段落 | 内容概要 | 论证功能 |
|------|---------|---------|
| 1 | "在那些日子，我经常用天气报告作为给蒂娜的电子邮件的开头" | 开篇：日常 |
| 2 | "两年后，我离开了工作室公寓..." | 新公寓 |
| 3 | "一个朋友可以面对面交谈..." | 玛丽娜 |
| 4 | "信天翁云的来信没有提到..." | 文章的起源 |
| 5 | "多年后，在我目前居住的公寓里..." | 后续 |
| 6 | "我是一个早起的人..." | 写作过程 |
| 7 | "那天早上我写的东西让我吃惊..." | 文章的内容 |
| 8 | "有时人们会把我当作任务..." | 文章的影响 |
| 9 | "散文以一个有趣的故事开始..." | 文章结构 |
| 10 | "我有时会被人们当作任务..." | 反应 |
...
> "When this happens it means that the thoughts have long been gestating and writing is only a birth of what was already taking form out of sight."

> "It's an assumption that has resulted in death for many victims of domestic violence and stalking."

> "And in all that I am ordinary."

> "It prompted an anonymous commenter at the website LiveJournal to coin the word mansplaining soon after it first appeared, a word that caught on, that entered the Oxford English Dictionary in 2014, that is now widely known and used in English, exists in dozens of languages, and has begat a host of variations such as whitesplaining."
...
**中文理解**：在那些日子，我经常用天气报告作为给蒂娜的电子邮件的开头，因为她已经搬到很远的地方任教，想念湾区。我们多年来几乎每天都在写作，有时一天多次。2008年3月24日，我们一直在继续3月20日一封我标题为"满月、春分、美丽的日子但很冷"的电子邮件的往来。3月24日晚上，我给她写了一封新标题为"黄昏前长长的淡鱼骨云"的信。Solnit 用"FULL MOON, EQUINOX, PRETTY DAY BUT CHILLY"将"电子邮件"定义为一种"日常"：不是"写作"，而是"日常"；不是"文学"，而是"生活"。

**句子结构**：长复合句，"In those days I often headed my emails to Tina with weather reports, since she had moved far away for a teaching position and missed the Bay Area"。

**关键词**：**headed**（标题）是核心词——它暗示一种"日常"：不是"写作"，而是"日常"。

**表达方式**：Solnit 用"LONG FAINT HERRINGBONE CLOUDS BEFORE DUSK"的诗意标题，将"天气"定义为一种"艺术"。

**为什么这样写**：这段话是全书"日常即艺术"主题的缩影。
...
**关键词**：**convalescing**（休养）是核心词——它暗示一种"恢复"：不是"健康"，而是"恢复"。

**表达方式**：Solnit 用"nestled in"的比喻，将"休养"定义为一种"舒适"。

**为什么这样写**：这段话是全书"友谊即避难"主题的缩影。
...
**句子结构**：长复合句，"The herringbone clouds letter didn't mention that I had been joking that night, as I had for years, about writing an essay called 'Men Explain Things to Me'"。

**关键词**：**joking**（开玩笑）是核心词——它暗示一种"日常"：不是"严肃"，而是"日常"。

**表达方式**：Solnit 用"energetically urged"的表述，将"鼓励"定义为一种"能量"。

**为什么这样写**：这段话是全书"笑话即严肃"主题的缩影。
...
**关键词**：**poured out**（倾泻）是核心词——它暗示一种"流动"：不是"强迫"，而是"流动"。

**表达方式**：Solnit 用"did her bidding"的表述，将"写作"定义为一种"服从"：不是"自我表达"，而是"服从"。

**为什么这样写**：这段话是全书"写作即诞生"主题的缩影。
...
**句子结构**：长复合句，"What I wrote that morning startled me, because when I had been joking the night before, I hadn't connected men explaining things to me to what I would write that morning"。

**关键词**：**startled**（吃惊）是核心词——它暗示一种"惊讶"：不是"计划"，而是"惊讶"。

**表达方式**：Solnit 用"holding forth"的表述，将"男人"定义为一种"表演"。

**为什么这样写**：这段话是全书"写作即惊讶"主题的缩影。
...
**关键词**：**spectrum**（光谱）是核心词——它暗示一种"连续"：不是"二元"，而是"连续"。

**表达方式**：Solnit 用"Making black people drink out of separate drinking fountains and lynching them are different in degree and kind"的对比，将"种族暴力"定义为一种"光谱"。

**为什么这样写**：这段话是全书"暴力即光谱"主题的缩影。
...
**句子结构**：超长复合句，"Since the essay I wrote that morning was published, I've heard from lawyers, scientists, doctors, scholars in many fields..."

**关键词**：**inherent**（固有的）是核心词——它暗示一种"固有"：不是"习得"，而是"固有"；不是"中立"，而是"性别化"。

**表达方式**：Solnit 用"let his sense of self expand as hers shrivels"的对比，将"权力"定义为一种"零和游戏"。

**为什么这样写**：这段话是全书"知识即权力"主题的缩影。
...
**关键词**：**credible**（可信的）是核心词——它暗示一种"可信"：不是"事实"，而是"可信"；不是"证据"，而是"身份"。

**表达方式**：Solnit 用"That she was crazy, on the other hand. . . ."的省略，将"疯狂"定义为一种"默认"。

**为什么这样写**：这段话是全书"可信度即阶级"主题的缩影。
...
**关键词**：**headed**（走向）是核心词——它暗示一种"旅程"：不是"计划"，而是"旅程"。

**表达方式**：Solnit 用"places I did not know I was going to go"的表述，将"写作"定义为一种"未知"。

**为什么这样写**：这段话是全书"写作即旅程"主题的缩影。
...
**句子结构**：短句，"And in all that I am ordinary" + "After all, I live in a society where rape kits and campus stalking awareness month and domestic violence shelters in which women and children are supposed to hide from husbands and fathers are normal fixtures"。

**关键词**：**ordinary**（平凡的）是核心词——它暗示一种"平凡"：不是"特殊"，而是"平凡"。

**表达方式**：Solnit 用"normal fixtures"的表述，将"暴力"定义为一种"常态"。

**为什么这样写**：这段话是全书"平凡即力量"主题的缩影。
...
| 词/短语 | 释义 | 例句 |
|---------|------|------|
| convalescing | 休养，恢复 | we were nestled in, **convalescing**, each in our own way |
| gestating | 孕育，酝酿 | thoughts have long been **gestating** |
| spectrum | 光谱，范围 | a lot of things on a **spectrum** |
| inherent | 固有的，天生的 | knowledge was **inherent** in them |
| shrivel | 萎缩，枯萎 | as hers **shrivels** |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句 |
|---------|------|------|
| dwelling | 住所，住处 | a more spacious attic **dwelling** |
| diagnosis | 诊断 | the alarming **diagnosis** I'd received |
| spindle-legged | 纺锤腿的 | the old **spindle-legged** desk |
| bidding | 要求，命令 | did her **bidding** |
| anecdote | 轶事，趣闻 | Marina heard in my **anecdotes** the possibility of telling that to the world |

### ⭐ 基础

| 词/短语 | 释义 | 例句 |
|---------|------|------|
| essay | 散文，随笔 | writing an **essay** called "Men Explain Things to Me" |
| author | 作者，作家 | am the **author** of that "very important book" |
| incident | 事件，事故 | in an **incident** from five years earlier |
| assumption | 假设，假定 | the same **assumption** that you are incompetent |
| credible | 可信的，可靠的 | simply not a **credible** explanation |

---

## 一句话总结
Solnit 通过《男人向我解释事情》这篇散文的诞生，探讨了"写作"作为一种"诞生"——不是"努力"，而是"诞生"；不是"创造"，而是"发现"；而"平凡"不是"特殊"，而是"常态"——"在所有这些中，我都很平凡"。
