...
状态: 未读
modified: "2026-09-25"
source_text: ch40_39_congratulations_you_ve_won_russian_ro.txt
---
# 40. Congratulations Youve Won Russian Roulette（恭喜，你赢得了俄罗斯轮盘）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 39
- **作者**：Rolf Dobelli
- **章节定位**：关于替代路径与风险
- **字符数**：4,255
- **一句话主旨**：只看成功结果会隐藏通往结果的未选择路径和潜在风险。

## 论证结构

- **核心论点**：财富和成功不能脱离通往它们的路径来判断；高风险所得与稳定劳动所得具有不同的风险调整后价值。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|---|---|---|
| 俄罗斯轮盘赢得一千万 | 极端案例 | 同一结果背后有死亡与生存的分叉 |
| 律师二十年积累一千万 | 比较案例 | 稳定收入缺少巨额损失路径 |
| 纽约与乡村律师收入差异 | 比较 | 未选择路径的重要性可大可小 |
| 金融衍生品投机 | 现实案例 | 暴利交易同时伴随破产替代路径 |
| 晚餐抛硬币 | 日常例子 | 替代路径也能重写一次消费的责任感 |

- **论证脉络**：俄罗斯轮盘故事 → 两条财富路径的对照 → 替代路径定义 → 金融风险与日常例子 → 结论：成功必须连同风险一起评价。
- **可质疑处**：作者把“同样金额”视为可比较的财富，却忽略了风险承受力、偏好、时间价值和不可逆损失；会计学视角的反驳也没有展开。

## 选择性精读

### ① 俄罗斯轮盘提议

> **原句 1:** "Want to play Russian roulette?"
...
**为什么这样写**：日常例子显示替代路径不只属于金融投机，也参与我们对付出、运气和公平的解释。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| alternative path | 替代路径 | "Alternative paths are all the outcomes..." |
| risk | 风险 | "a huge risk" |
| lurks | 潜藏 | "the risk that lurks behind each of the $10 million." |
| speculate | 投机 | "Those who speculate on junk bonds" |
| ruin | 毁灭 | "lead straight to ruin." |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| roulette | 轮盘赌 | "Russian roulette" |
| revolver | 左轮手枪 | "The revolver contains a single bullet" |
| affluent | 富裕的 | "the more affluent residents" |
| junk bond | 垃圾债券 | "speculate on junk bonds" |
| warrant | 证明……合理 | "your success is warranted" |

### ⭐ 基础

| 词/短语 | 例句（原文） |
|---|---|
| money | "a suitcase ... filled ... with stacks of money" |
| risk | "a huge risk" |
| lawyer | "a prominent lawyer" |
| dinner | "half of this dinner" |
| pay | "you’ve actually already paid" |

## 一句话总结

判断一个结果时，必须同时想象没有发生的路径；否则，高风险带来的财富会被误认成与稳定劳动所得完全等价。
