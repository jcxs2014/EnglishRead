...
状态: 未读
modified: "2026-09-25"
source_text: ch55_54_would_you_wear_hitler_s_sweater_conta.txt
---
# 55. Would You Wear Hitlers Sweater（你会穿希特勒的毛衣吗）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 54
- **作者**：Rolf Dobelli
- **章节定位**：关于传染偏误
- **字符数**：4,188
- **一句话主旨：物品会被赋予与其当前物质内容无关的象征意义，人们会本能地回避被认为沾染了禁忌或危险的东西。

## 论证结构

- **核心论点**：情感会把人与物品、人群和地点联系起来，产生“接触就会沾染”的直觉；这种传染观念可跨越理性而不消失。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|---|---|---|
| 中世纪圣物与和平 | 历史案例 | 圣物和遗迹具有道德约束力 |
| 希特勒毛衣 | 思想实验 | 无物质残留仍会引发拒绝 |
| 亲人照片飞镖实验 | 实验研究 | 人们不敢射中亲近者照片 |
| 萨达姆酒杯 | 日常故事 | 物品来源会压过实际物质联系 |

- **论证脉络**：中世纪宗教权威 → 现代禁忌问题 → 飞镖实验 → 战利品酒杯 → 传染偏误定义与结论。
- **可质疑处**：传染偏误的“神秘力量”是文化与情绪现象，不应被当作物理因果；其社会功能也可能是维护群体边界和道德禁忌。

## 选择性精读

### ① 圣物

> **原句 1:** "Anything that had ever come in contact with a saint."
...
**为什么这样写**：酒杯的内容物没有改变，客人的反应却证明来源和意义可以独立于物质传播。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| contagion bias | 传染偏误 | "Contagion Bias" |
| intangible | 无形的 | "intangible forces" |
| mystic | 神秘的 | "a mystic force" |
| relic | 遗物 | "all the relics" |
| conscience | 良知 | "their conscience" |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| reverence | 敬畏 | "enormous reverence" |
| superstition | 迷信 | "this silly superstition" |
| molecule | 分子 | "a single molecule" |
| hesitant | 犹豫的 | "the subjects’ hesitation was palpable" |
| palpable | 明显的 | "the subjects’ hesitation was palpable." |

### ⭐ 基础

| 词/短语 | 例句（原文） |
|---|---|
| sweater | "put on a freshly laundered sweater" |
| contact | "come in contact with a saint" |
| target | "pinned to the center of targets" |
| glass | "six gold-plated wineglasses" |
| wine | "spat his wine" |

## 一句话总结

我们不只是判断物品的组成，还判断它与谁发生过关系；这种象征性联结既维系道德边界，也可能制造不必要的恐惧。