...
状态: 未读
modified: "2026-09-25"
source_text: ch87_86_build_your_own_castle_envy.txt
---
# 87. Build Your Own Castle（建造自己的城堡）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 86
- **作者**：Rolf Dobelli
- **章节定位**：关于嫉妒
- **字符数**：4,003
- **一句话主旨**：嫉妒源于与他人的相似比较，却不带来实际优势；停止比较并建立自己的专长领域，才能把嫉妒转化为行动。

## 论证结构

- **核心论点**：嫉妒是进化遗留的高效但不合理的情绪；应把自己与更相似的人比较，专注建立能力圈。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|---|---|---|
| 工资三情境 | 思想实验 | 看到别人收入上升最令人不适 |
| 农夫神灯 | 寓言 | 嫉妒可能产生破坏性欲望 |
| Balzac 引语 | 文学证据 | 嫉妒没有单一实际收益 |
| Peter–Sam–女孩 | 概念区分 | envy 需要两人，jealousy 需要三人 |
| 同类比较 | 社会观察 | 嫉妒集中于相似者 |
| 搬到曼哈顿 | 日常案例 | 更换参照群体会制造新嫉妒 |

- **论证脉络**：选择情境 → 寓言故事 → 情绪命名 → 概念区分 → 比较机制 → 应对方案 → 进化背景。
- **可质疑处**：停止比较并不容易，且不嫉妒也可能掩盖正当的不满或不公平感。

## 选择性精读

### ① 绿眼怪

> **原句 1:** "You’re just another victim of the green-eyed monster."

**中文理解**：你不过是绿眼怪物的另一个受害者。
...
**为什么这样写**：它把停止比较后的目标具体化为建立一处自己说了算的专业领域。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| envy | 嫉妒 | "Envy is the most stupid" |
| jealousy | 嫉妒、妒忌 | "The difference" |
| resentment | 怨恨 | "direct resentments" |
| circle of competence | 能力圈 | "circle of competence" |
| niche | 利基领域 | "Create a niche" |
...
|---|---|---|
| spark | 引发 | "spark envy" |
| curse | 诅咒；恶习 | "of vices" |
| similarity | 相似性 | "most similar to us" |
| neighbor | 邻居 | "If my neighbor" |
| pangs | 阵痛 | "pangs of envy" |

### ⭐ 基础

| 词/phrase | 例句（原文） |
|---|---|
| salary | "friends’ salaries" |
| money | "status, money, health" |
| health | "your health" |
| career | "age, career" |
...
把嫉妒当作比较信号，而不是自我评价；真正要解决的是如何在自己的领域建立不可替代的能力。
