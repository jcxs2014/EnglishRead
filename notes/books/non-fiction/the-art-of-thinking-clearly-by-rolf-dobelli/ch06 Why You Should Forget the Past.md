...
状态: 未读
modified: "2026-09-25"
source_text: ch06_5_why_you_should_forget_the_past_sunk_co.txt
---
# 06. Why You Should Forget the Past（为什么你应该忘记过去）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 5
- **作者**：Rolf Dobelli
- **章节定位**：全书第 5 个认知偏差单元
- **字符数**：约 3,500 字符
- **一句话主旨**：沉没成本谬误让人因为已经投入时间、金钱、精力或爱而继续一项没有未来收益的事；理性决策只能依据尚未发生的成本与收益。

## 论证结构

- **核心论点**：已经支付且无法收回的成本不应影响下一步决策；继续投入常常只是为了维护一致性与面子，而不是为了改善未来结果。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|------|------|---------|
| 电影票与营销活动 | 日常案例 | 已花的钱不能构成继续留下的理由 |
| 朋友与出轨伴侣的关系 | 关系案例 | 投入精力会让人继续留在失败关系中 |
| 股票投资者依据购入价决策 | 金融案例 | 购入价格与未来表现无关 |
| Concorde 与越南战争 | 历史案例 | 国家也会用沉没成本维护面子与承诺 |

- **论证脉络**：个人争执 → 商业项目 → 亲密关系 → 投资 → 一致性动机 → 政府案例 → 只看未来的决策原则。
- **可质疑处**：作者承认为了完成某项投资可能有正当理由，但没有提供区分“值得完成的未来收益”与“为了挽回过去”的操作标准。

## 选择性精读

### ① 电影中的错误理由

> **原句 1:** "No way. We’re not throwing away thirty dollars."
...
**为什么这样写**：作者不是简单劝人止损，而是给出可复用的判断原则，让读者在下一次投入前重新排序信息。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| sunk cost fallacy | 沉没成本谬误 | "The money’s already gone. This is the sunk cost fallacy at work—a thinking error!" |
| advertising campaign | 广告活动 | "Our advertising campaign had been running for four months..." |
| acquisition prices | 购入价格 | "Often they base their trading decisions on acquisition prices." |
| consistency | 一致性 | "This irrational behavior is driven by a need for consistency." |
| non-recoverable | 不可收回的 | "such as to justify non-recoverable investments." |

### ⭐⭐ 进阶
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| throw away | 扔掉；放弃 | "We’re not throwing away thirty dollars." |
| regardless of | 不管；无论 | "regardless of whether we stay or leave" |
| future performance | 未来表现 | "What counts is the stock’s future performance..." |
| credit | 信誉；可信度 | "After all, consistency signifies credibility." |
| save face | 保全面子 | "if only to save face." |

### ⭐ 基础
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| decision | 决定 | "This factor should not play a role in our decision." |
| money | 钱 | "We have spent the thirty dollars..." |
| relationship | 关系 | "I’ve invested so much energy in the relationship..." |
| project | 项目 | "If we decide to cancel a project halfway through..." |
| benefit | 收益 | "future costs and benefits" |

## 一句话总结**

沉没成本谬误把“已经付出多少”偷换成“是否值得继续”，而理性原则要求把过去从决策中删除，只依据未来可能增加的成本与收益行动。