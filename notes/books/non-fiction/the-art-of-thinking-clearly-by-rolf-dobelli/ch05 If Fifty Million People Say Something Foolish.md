...
状态: 未读
modified: "2026-09-25"
source_text: ch05_4_if_fifty_million_people_say_something_.txt
---
# 05. If Fifty Million People Say Something Foolish（即使五千万人说同一件蠢事，它仍然是蠢事）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 4
- **作者**：Rolf Dobelli
- **章节定位**：全书第 4 个认知偏差单元
- **字符数**：约 3,800 字符
- **一句话主旨**：社会认同使人们把他人的行为当作正确性的证据；这种在史前可能有利于生存的本能，在现代群体、广告和舆论中却会制造盲从与集体错误。

## 论证结构

- **核心论点**：人数不能直接证明一个观点或行为正确；从众冲动源于古老的生存机制，但今天常被利用来制造恐慌、泡沫和危险共识。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|------|------|---------|
| 仰头看天、跟着鼓掌和留下小费 | 案例 | 社会认同在无意识中运作 |
| Solomon Asch 线段实验 | 研究案例 | 群体压力会扭曲个人判断 |
| 塞伦盖蒂逃跑的假想场景 | 进化解释 | 从众曾经具有生存价值 |
| 喜剧中的罐头笑声 | 媒介案例 | 群体反应可以被制造 |
| 广告中的“像你和我的人” | 商业案例 | 不确定情境容易被销量带动 |

- **论证脉络**：日常动作举例 → 定义社会认同 → 指出群体风险 → Asch 实验 → 进化解释 → 媒体与商业利用 → 保持怀疑。
- **可质疑处**：作者用“绝对智慧”式反问收束，但没有区分低风险的社会学习与高风险的集体决策；从众在信息稀缺时可能是合理的启发式。

## 选择性精读

### ① 仰望天空

> **原句 1:** "At an intersection, you encounter a group of people, all staring at the sky. Without even thinking about it, you peer upward, too."

**中文理解**：在十字路口，你遇到一群仰望天空的人，几乎不假思索，你也跟着抬头。
...
**为什么这样写**：从众最适合信息不足的情境，广告因此把“销量”与“相似人群”包装成质量代理。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| social proof | 社会认同 | "Social proof, sometimes roughly termed the “herd instinct,” dictates that individuals feel they are behaving correctly..." |
| herd instinct | 群体本能 | "sometimes roughly termed the “herd instinct”" |
| survival advantage | 生存优势 | "even when it offers no survival advantage." |
| canned laughter | 罐头笑声 | "Comedy and talk shows make use of social proof by inserting canned laughter at strategic points, inciting the audience to laugh along." |
| consent | 同意 | "nobody would have consented to this crazy proposal." |

### ⭐⭐ 进阶
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| peer pressure | 同伴压力 | "shows how peer pressure can warp common sense." |
| distort | 扭曲 | "peer pressure can warp common sense." |
| appropriate | 合适的；恰当的 | "the more appropriate this behavior is judged by others." |
| individually | 单独地；分别地 | "If the attendees had been asked individually..." |
| anonymously | 匿名地 | "and anonymously" |

### ⭐ 基础
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| group | 群体 | "you encounter a group of people" |
| idea | 想法 | "follow a certain idea" |
| behavior | 行为 | "display a certain behavior" |
| audience | 观众 | "inciting the audience to laugh along." |
| proposal | 提议 | "this crazy proposal." |

## 一句话总结

社会认同把“别人这样做”偷换成“这样做才正确”，而进化遗产、群体心理与商业营销共同维持了这种错觉；真正需要恢复的，是把人数重新放回信息质量之外。