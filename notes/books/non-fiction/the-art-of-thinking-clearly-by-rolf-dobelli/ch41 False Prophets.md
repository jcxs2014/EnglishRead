...
状态: 未读
modified: "2026-09-25"
source_text: ch41_40_false_prophets_forecast_illusion.txt
---
# 41. False Prophets（假先知）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 40
- **作者**：Rolf Dobelli
- **章节定位**：关于预测幻觉
- **字符数**：3,949
- **一句话主旨**：预测者因不受惩罚而制造大量预言，公众应要求查看其长期准确率和利益动机。

## 论证结构

- **核心论点**：专家预测的权威感不等于可靠性，评估预测必须看预测者的历史记录和激励结构。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|---|---|---|
| Philip Tetlock 评估 28,361 个预测 | 研究 | 专家准确率仅略高于随机预测 |
| 媒体宠儿与末日预言表现最差 | 数据 | 名气不保证预测质量 |
| 预测基金设想 | 制度设计 | 对错误预测施加成本可减少随意预测 |
| 复杂系统的长期预测 | 推理 | 越复杂、越远期，越难准确预测 |

- **论证脉络**：预测轰炸 → 专家表现研究 → 奖惩不对称 → 复杂系统不可预测 → 两步审查方法 → “我不做预测”的反讽收束。
- **可质疑处**：将预测准确率作为唯一标准可能忽略预测的概率表达、决策价值和不同领域的信息难度；Tetlock 的样本与指标在章节中未展开。

## 选择性精读

### ① 专家预测轰炸

> **原句 1:** "Every day, experts bombard us with predictions, but how reliable are they?"

**中文理解**：每天专家都用预测轰炸我们，但它们究竟有多可靠？
...
**为什么这样写**：前文刚教读者审查别人，这句把审查对象也转向作者本人，形成自我约束的修辞效果。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| forecast illusion | 预测幻觉 | "Forecast Illusion" |
| accuracy | 准确率 | "In terms of accuracy" |
| prediction | 预测 | "28,361 predictions" |
| incentive | 激励 | "what incentive does the expert have?" |
| track record | 历史记录 | "the pundit’s track record" |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| self-appointed | 自封的 | "self-appointed professionals" |
| consultant | 顾问 | "consultancy offers" |
| collapse | 崩溃 | "Regime shift in North Korea" |
| crude oil | 原油 | "No more crude oil" |
| reliable | 可靠的 | "how reliable are they?" |

### ⭐ 基础

| 词/短语 | 例句（原文） |
|---|---|
| expert | "experts bombard us" |
| money | "the money goes to charity." |
| chance | "a 33 percent chance" |
| prediction | "publications" |

## 一句话总结

面对预测，不应先问它听起来多么合理，而应先问预测者靠什么获利、过去究竟猜对过多少次。
