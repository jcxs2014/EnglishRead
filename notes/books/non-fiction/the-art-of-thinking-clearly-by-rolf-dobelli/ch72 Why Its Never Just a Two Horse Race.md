...
状态: 未读
modified: "2026-09-25"
source_text: ch72_71_why_it_s_never_just_a_two_horse_race_.txt
---
# 72. Why Its Never Just a Two Horse Race（为什么从来不只是两匹马比赛）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 71
- **作者**：Rolf Dobelli
- **章节定位**：关于替代方案盲视
- **字符数**：4,222
- **一句话主旨**：人容易把选择误写成当前方案与不做之间的二选一，却忘记比较真正的次优替代方案。

## 论证结构

- **核心论点**：决策质量取决于比较集合；忽略其他可行方案，会把昂贵或危险的选择包装成唯一选项。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|---|---|---|
| MBA 宣传册 | 商业案例 | 费用、机会成本和远期预测被隐藏 |
| 1% 与 5% 债券 | 投资案例 | 不能只比较储蓄和债券 |
| Warren Buffett | 人物引语 | 决策应与次优方案比较 |
| 体育场建设 | 公共决策 | 空地不应只与体育场比较 |
| 肿瘤手术 | 医疗决策 | 还可能有低风险变体与未来疗法 |

- **论证脉络**：MBA 宣传 → 四种谬误 → 债券 → 城市规划 → 医疗选择 → 扩大选择集。
- **可质疑处**：作者主要展示替代方案被忽略的风险，没有讨论信息不足时比较更多选项的成本，也可能使决策过度复杂。

## 选择性精读

### ① 四个谬误

> **原句 1:** "Such an argument hides not one but four fallacies."

**中文理解**：这样的论证隐藏的不止一个，而是四个谬误。
...
**为什么这样写**：医疗案例把替代方案盲视从抽象原则变成了生死选择中的具体遗漏。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| fallacy | 谬误 | "four fallacies" |
| alternative blindness | 替代方案盲视 | "alternative blindness" |
| income | 收入 | "graduates earn" |
| viable | 可行的 | "other, superior alternatives" |
| compare | 比较 | "compare the bond" |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| brochure | 宣传册 | "leaf through a brochure" |
| tuition | 学费 | "the $100,000 fee" |
| earn | 赚取 | "graduates earn" |
| results | 结果 | "results" |
| arena | 体育场 | "build a sports arena" |

### ⭐ 基础

| 词/phrase | 例句（原文） |
|---|---|
| university | "the university’s MBA degree" |
| student | "smiling students" |
| money | "You have a little money" |
| investment | "investment options" |
| hospital | "a hospital" |

## 一句话总结

遇到二选一时先不要接受框架：把“做/不做”改成完整选项表，再比较次优方案，才知道选择是否真的划算。