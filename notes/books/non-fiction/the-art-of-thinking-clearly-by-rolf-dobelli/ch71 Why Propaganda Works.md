...
状态: 未读
modified: "2026-09-25"
source_text: ch71_70_why_propaganda_works_sleeper_effect.txt
---
# 71. Why Propaganda Works（宣传为何有效）

## 概览

- **出处**：*The Art of Thinking Clearly*，Chapter 70
- **作者**：Rolf Dobelli
- **章节定位**：关于睡眠者效应
- **字符数**：3,912
- **一句话主旨**：人们会忘记信息来自宣传来源，却保留信息内容，因此不可信来源的影响可能随着时间增强。

## 论证结构

- **核心论点**：来源与论点会在记忆中以不同速度消退；来源先消失，使观点逐渐脱离其原始的不信任背景。
- **证据链**：

| 证据 | 类型 | 支撑什么 |
|---|---|---|
| 二战宣传电影研究 | 实验研究 | 观影后九周支持度反而提高 |
| 论点半衰期 | 心理学类比 | 普通说服力会随时间衰减 |
| Carl Hovland 研究 | 理论解释 | 来源比内容消退更快 |
| 政治广告 | 现实应用 | 指控内容在来源淡忘后留存 |
| 书籍与广告对比 | 日常建议 | 记住来源能够抵抗操纵 |

- **论证脉络**：宣传电影 → 即时无效 → 九周后有效 → 记忆机制 → 政治广告 → 防护方法。
- **可质疑处**：实验和记忆解释主要来自特定战争宣传材料，不能直接推断所有政治广告都会以同样速度产生持久影响。

## 选择性精读

### ① 研究结果

> **原句 1:** "The result was disappointing: They did not intensify the privates’ enthusiasm for war in the slightest."

**中文理解**：结果令人失望：他们丝毫没有加强士兵对战争的热情。
...
**为什么这样写**：如果来源标签保留在记忆中，观点就不容易在之后获得不该有的可信度。
...
| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| propaganda | 宣传 | "Why Propaganda Works" |
| sleeper effect | 睡眠者效应 | "the sleeper effect" |
| discredit | 使丧失可信度 | "the discrediting force" |
| credibility | 可信度 | "gains credibility over time" |
| unsolicited | 未经请求的 | "unsolicited advice" |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句（原文） |
|---|---|---|
| enthusiasm | 热情 | "enthusiasm for their country" |
| half-life | 半衰期 | "It has a half-life" |
| undecided | 尚未决定的 | "undecided voters" |
| sponsor | 赞助者 | "disclose its sponsor" |
| contaminate | 污染 | "ad-contaminated sources" |
...
|---|---|
| nation | "every nation" |
| soldier | "regular soldiers" |
| war | "support for the war" |
| message | "the message itself" |
| book | "books are (still) ad-free" |

## 一句话总结

记住观点，也要记住观点来自谁；来源一旦从记忆中消失，原本可疑的信息就可能伪装成独立事实。