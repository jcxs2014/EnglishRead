...
**关键情节——Clara 被捕：**
- Kinnock 用"匿名告密者"的借口进入 Clara 办公室——Kinnock **再次撒谎**来掩盖 Lily 的存在："It was someone spying on Miss Knight. They wanted to remain anonymous..."
- **Sally (DC Whitley) 起疑**——Sally "couldn't say why, but there was something about this case that bothered her. The normally implacable DCI had been acting very strangely"——**Sally 注意到 Kinnock 的行为异常**（"disappearing at all times of the day to ask them more vague questions"）。
- **Kinnock 的掩护故事**：他编造了一个"有人赌 Clara 看软性情色片"的假故事——"A Hard Habit to Break and Confess and Caress as being the top runners. They couldn't resist spying so they could win a few bob."——**Kinnock 用"赌局"**来掩盖"鬼魂告密"**。
- **灵魂茶成分**：Clara 亲口说"I call it my soul tea... Mitragyna speciosa, the kratom plant—it has a stimulating, euphoric effect. I added some to the tea I gave him."——**灵魂茶含**"**马来酸**"（kratom），**不是 Angel's Trumpet**——**但 Kinnock 警告"if this is actually Angel's Trumpet"**——**灵魂茶可能有两种成分**。
- **Clara 被捕**："Miss Clara Knight, you are under arrest on suspicion of administering a noxious substance."——**Clara 因"施用有害物质罪"被捕**。

**关键情节——Giles 与 Layla 私情：**
- Lily 潜入 Layla 的花车 → 从通风口逃出 → 进入 Layla 家后花园（"The Secret Garden"）→ 在温室里看到 Giles 与 Layla 亲热。
- **两人对话的关键信息**：
  - Layla 说"he dumped you for being too old"——**Alex 因为"你太老了"抛弃 Layla**——**Layla 的动机是"被抛弃的愤怒"**。
  - Giles 说"You've been in my pants for some time now, you knew how much Alex meant to me"——**Layla 在 Giles 的裤子里"待了很久"**——**Giles 因为"想复合"而接近 Layla**——**Giles 的动机是"情敌报复"**。
  - Layla 说"you were the only reason I was asked to work on that bloody film in the first place"——**Layla 是因为 Giles 才被雇来的**——**Giles 安排 Layla 出现在片场**。
  - Giles 说"I was only trying to help. I thought leaving those leaflets around would be a great way to boost your business"——**Giles 散播 Exotic Blooms 传单**——**Giles 是"灵魂茶/天使号角"传播的**"**中间人**"**。
  - 两人讨论"lay low until the whole thing blows over"——**两人在**"**共谋**"**逃避调查**。

**段落逻辑链：**
1. Kinnock 走向 Clara 办公室 → Sally 起疑（"something about this case that bothered her"）→
2. **Kinnock 编造"赌局"掩护故事**——"A Hard Habit to Break"赌局 → Sally 接受 →
3. Kinnock 进入 Clara 办公室 → Lily 在暗处观看 →
4. **Clara 崩溃**——"I only wanted to save his soul" → Clara 交出灵魂茶 →
5. **灵魂茶成分揭晓**：mitragyna speciosa (kratom) → Kinnock 警告"if this is actually Angel's Trumpet"→
6. **Clara 被捕**——"on suspicion of administering a noxious substance" → Clara 昂首走出办公室（"I am answering the call of the Lord"）→ 被全剧组嘲笑 →
7. **Lily 潜入 Layla 花车**——通过通风口逃出 → 进入 Layla 家花园 →
8. **Giles-Layla 私情**——两人亲热 → 对话暴露动机和"共谋"→
9. Lily 回到 Rita 房车 → 与 Ash 讨论 →
10. **Ash & Lily 推理汇总**：Clara 可能是凶手 / Layla 和 Giles 可能合谋 / Anna 不能排除 / Petrov 也不能排除 →

**结构性关键：** 这一章**同时推进三条主线**——
1. **Clara 线**：Clara 被捕，**灵魂茶不是 Angel's Trumpet**——**Clara 的嫌疑从"直接凶手"降为"可能的共犯"**。
...
- 关键词：sweepstake（**"赌局"**——Kinnock 编造的"赌局"是**"赌 Clara 看什么片"**——**Kinnock 用**"**低级趣味的赌局**"**来掩盖**"**鬼魂告密**"）、A Hard Habit to Break / Confess and Caress（**两部 1970s 情色片名**——Kinnock 用具体的片名**让赌局显得真实**——**这些片名本身就是**"**Clara 性格的讽刺**"**：**一个**"**宗教狂热者**"**被**"**赌她在看色情片**"）、a few bob（**"几块钱"**——Kinnock 用英式俚语**让故事显得真实**——**"a few bob"是**"**英国工人阶级**"**的俚语**"）。
- 表达方式：**Kinnock 的"赌局"掩护故事是**"**全书最精妙的谎言**"**——**Kinnock 用**"**具体的片名**"**、**"**具体的赌注**"**、**"**具体的俚语**"**来**"**构建一个**"**可信的假故事**"**。**这个**"**谎言**"**比**"**Kinnock 直接说"是鬼告诉我的"**"**更可信**。
- 为什么这样写：**Kinnock 的"撒谎"是本书对"警方伦理"的**"**最复杂的描写**"**——**Kinnock **为了**"**正义**"**而**"**撒谎**"**——**Kinnock **的**"**撒谎**"**是**"**"善意的谎言**"**，**但**"**善意的谎言**"**也是**"**谎言**"。
- **读者视角提示**：**Kinnock 的"赌局"是**"**本书对"警方-民间合作"的**"**最大风险**"**——**如果**"**Sally **发现**"**Kinnock **的**"**谎言**"**，**Kinnock **的**"**职业生涯**"**就**"**完了**"**。**Sally 的**"**起疑**"**是**"**本章最危险的**"**悬念**"。

**②** "'I call it my soul tea. I order it especially for people like Alex. Mitragyna speciosa, the kratom plant—it has a stimulating, euphoric effect. I added some to the tea I gave him, to give him a much-needed spiritual experience, bring him closer to our Lord.' Her voice hitched a little, a solitary tear falling from her eye. 'I might have given him too much, I suppose. But it's far more likely that those stupid people sent me the wrong plant altogether. You never know what you're going to get from these backward countries.'"
- 中文理解："我叫它灵魂茶。我专门为像 Alex 这样的人订购。Mitragna speciosa，也就是 kratom 植物——它有刺激、欣快的效果。我加了一些给我给他的茶里，好让他有一个急需的灵性体验，让他更接近我们的主。"她的声音哽咽了一下，一滴孤独的泪水从她眼中落下。"我可能给多了。但更有可能的是那些愚蠢的人给我寄错了植物。你永远不知道从这些落后国家会得到什么。"
- 关键词：Mitragyna speciosa（**"Mitragna speciosa"**——**kratom 的学名**——Clara **用学名来**"**显示**"**她的**"**知识**"**——**但**"**克拉托**"**不是**"**Angel's Trumpet**"**——**Clara **的**"**灵魂茶**"**和**"**Angel's Trumpet**"**是**"**两种植物**"）、backward countries（**"落后国家"**——Clara **对**"**东南亚**"**（kratom 的产地）的**"**种族歧视语言**"**——**Clara **的**"**宗教狂热**"**和**"**种族歧视**"**并存**"）。
- 表达方式：**Clara 的"backward countries"是**"**全书对"宗教狂热 + 种族主义"的**"**最直接的描写**"**——**Clara **用**"**"落后国家**"**来**"**贬低**"**kratom **的产地**"**——**Clara **的**"**宗教"爱"**"和**"**种族**"**仇恨**"**是**"**同一种**"**东西**"。
- 为什么这样写：**Clara 的"backward countries"是**"**本书对"宗教伪善"的**"**最终极**"**的**"**讽刺**"**——**Clara **声称**"**爱**"**Alex **的灵魂**"，**但**"**Clara **对**"**kratom **的产地**"**的**"**种族歧视**"**显示**"**Clara **的**"**爱**"**是**"**有条件的**"**——**Clara **只**"**爱**"**"她**"**认为**"**应该**"**爱的人**"。
- **读者视角提示**：**"Mitragna speciosa ≠ Angel's Trumpet"是**"**本章最关键的**"**推理转折**"**——**灵魂茶**"**不是**"**Angel's Trumpet**"**——**这意味着**"**Clara **的灵魂茶**"**可能**"**不是**"**凶器**"**。**但**"**Clara **说**"**"those stupid people sent me the wrong plant altogether"**"**——**Clara **承认**"**她**"**收到**"**的**"**东西**"**可能**"**是**"**错的**"**——**"寄错"**"**的植物**"**可能就是**"**Angel's Trumpet**"。
...
- **Giles-Layla 私情**：两人偷情数月，两人都有动机和机会，两人讨论"lay low"——**Giles 和 Layla 可能合谋**。
