...
**人物弧线**：Reggie 对 Calvin 的信任在增长（开始 loop him in），但仍试图保护他不知道 Eldi 的真相；Calvin 的科学理性主义开始被真实的异常现象动摇。

**叙事手法**：双线交织（扫地机器人调查 + 神秘信息源邮件）；电话场景的紧张感；借 Calvin 追问引出 Reggie 的过往（曾为一位富豪办案，从中挪走足以过完余生的钱）。
...
> **原句 3:** "She knows about Eldi. She's looking for her. Tell Regina."

**中文理解**："她知道 Eldi。她在找她。告诉 Regina。"

**关键词**：she（她）——神秘来电者用"she"指代；Calvin 被卷入 Reggie 最想隐藏的秘密；这是全章最直接的威胁暗示。
...
**中文理解**：她把手放在平板电脑屏幕上，一道明亮的绿色光线，像激光一样，从顶端射出，上下扫描她的脸。
...
| 词汇 | 音标 | 释义 | 例句 |
|------|------|------|------|
| imbued | /ɪmˈbjuːd/ | 灌输的；充满的 | "Magically imbued objects exist" |
| cryptic | /ˈkrɪptɪk/ | 神秘的；含糊的 | "Their messages are always cryptic." |
| impending | /ɪmˈpendɪŋ/ | 即将发生的 | "the sixth sense that's warning me something big is impending" |
| covert | /ˈkoʊvɜːrt/ | 秘密的；隐蔽的 | "make a covert detour tomorrow" |

### ⭐⭐ 进阶

| 词汇 | 音标 | 释义 | 例句 |
|------|------|------|------|
| beeline | /ˈbiːlaɪn/ | 直线；径直 | "it made a beeline for the door" |
| paranoid | /ˈpærənɔɪd/ | 多疑的；偏执的 | "I'm trying to convince myself I'm being paranoid" |
| disgruntled | /dɪsˈɡrʌntld/ | 不满的；闷闷不乐的 | "Calvin sounds disgruntled as he hands me the beers" |
| bristle | /ˈbrɪsl/ | 被激怒；竖起毛发 | "Snarling, I bristle at the implication" |
| venom | /ˈvenəm/ | 恶毒；怨恨 | "I can't hide the venom in my voice" |
...
| spine | /spaɪn/ | 脊柱 | "A shiver runs down my spine." |

---

## 一句话总结

扫地机器人的"追踪 Eldi"行为、神秘信息源的警告邮件和"She knows about Eldi"电话汇聚成一个越来越清晰的图景：Eldi 不只是神秘生物，而是一个被 hunting 的存在，而 Reggie 的保护任务比她以为的更加危险。
