...
- 为什么这样写：用"screw loose"建立 Dominic 的"父性"——他保护 Orly 的"世界观"。
- 读者视角提示：Dominic 的"你没有孩子"是全书的"母性"主题——Rowan 正在"成为"母亲。
...
- 中文理解："你以为会有时间，但没有。你启动洒水系统，浇透防火带。你准备好水管。你检查排水沟是否干净。你打包行李。你以为会有时间打包更多，但它已经到了，撕裂山丘。你以为你会与之战斗，但你不能。无法阻止这场大火。"
- 关键词：firebreak——防火带；blaze——大火；tears through——撕裂。
- 为什么这样写：用"tears through"的动态暗示 Rowan 的"创伤"——火是"活的"。
- 读者视角提示：Rowan 的"无法阻止"是全书的"失去"主题。
...
- 中文理解："我布置得很好。我的防火带足够宽。我选用的建筑材料尽可能防火。但有桉树，三棵。我最喜欢的树。它们离房子有点太近，但我不能为此砍掉它们。我太爱它们了。最终一切为那些桉树烧毁了。因为火焰，它们跳跃。"
- 关键词：property——房产；fire resistant——防火的；eucalypts——桉树；leaped——跳跃。
- 为什么这样写：用"property"建立 Rowan 的"归属感"；"eucalypts"暗示 Rowan 的"矛盾"——她爱"自然"但自然"毁灭"了她。
- 读者视角提示：Rowan 的"太爱它们"是全书的"爱"主题——爱总是"失去"。

④ "It requires a look-in every few days—we have to check the temperature now the power's out, on top of which they have this sorting and packing task Hank left them. I've told them I'm coming, regardless of whether they want me to, regardless of how much it slows them down."

- 中文理解："需要每隔几天检查一次——断电后我们必须检查温度，除此之外他们还有 Hank 留下的分拣和打包任务。我告诉他们我要来。"
- 关键词：look-in——检查；sorting and packing——分拣和打包。
- 为什么这样写：用"look-in"建立 Dominic 的"责任感"；"sorting and packing"暗示 Hank 的"消失"——他留下了"任务"但没有"解释"。
- 读者视角提示：Dominic 的"检查温度"是全书的"守护"主题。

⑤ "There are two field huts: the closest has a blue door, the farther a red. Hank spent a lot of time living in the blue so that's where we go; his room is small and empty. There are no pictures, no personal items. He has cleared it out completely, so that when I sit on this bed where he slept, I feel no part of him, and when I climb between his sheets there is no smell to bring him back, nothing at all, I am alone."

- 中文理解："有两个田野小屋：最近的门是蓝色的。Hank 很多时间住在蓝色里，所以我们去了那里；他的房间又小又空。没有照片，没有个人物品。他把它完全清空了，所以我感觉不到他的任何部分，没有气味能把他带回来，什么都没有，我独自一人。"
- 关键词：cleared out——清空；no smell——没有气味；alone——独自。
...
| 词/短语 | 释义 | 例句 |
|---------|------|------|
| screw loose | 脑子有问题 | "You got a screw loose?" |
| simmering | 强压怒火的 | "the simmering man seated at the kitchen table" |
| astonished | 惊讶的 | "Dominic stares at me, astonished" |
| cope | 应对 | "he's able to cope with the image" |
...
| 词/短语 | 释义 | 例句 |
|---------|------|------|
| fumble | 笨拙地摸 | "I fumble with the coffee percolator" |
| percolator | 咖啡壶 | "the coffee percolator" |
| stove | 炉子 | "I get the coffee onto the stove" |
| gas | 燃气 | "light the gas" |
...
| told | 告诉 | "Telling my nine-year-old" |
| starve | 饿死 | "he'll starve" |
| asked | 问 | "He asked" |
...
ch22 用 Rowan 的"世界末日对话"建立全书的"真相"主题——她因告诉 Orly 真相而受到责备；她随 Dominic 前往种子库，在隧道中感受到岛屿的"鬼魂"；夜晚她躺在 Hank 的床上，感觉"独自一人"——但她的"心"正在转向 Dominic。
