...
## 本章导航
- **一句话概括**：Dom 决定去救 Hank；他准备了工具；他看着船消失在视野中。
- **情感弧线位置**：高潮——Dom 的"选择"是"救" Hank。
- **Tropes 兑现/反转**：The father——Dom 的"父性"是"救"；The protector——Dom 的"保护"是"不杀人"。
- **人物弧线**：Dom 从"暴力"到"拯救"——他"选择"不杀 Hank。
...
- 中文理解：在回家的路上，我决定最好不让这个混蛋淹死。Rowan 是对的。我不想让她承受我同样的损失。我不想背负他的死亡或遇见他的鬼魂。最重要的是，我不希望这件事的暴力让我女儿比她已经受到的惊吓更加害怕。
- 关键词：drown——淹死；bear——承受；loss——损失；ghost——鬼魂；violence——暴力；scare——惊吓。
- 为什么这样写：用"ghost"建立 Dom 的"恐惧"——他"害怕"鬼魂。
- 读者视角提示：Dom 的"不想"是全书的"父性"主题——他"选择"不杀。
...
- 中文理解：既然仓库太危险了，唯一的回去方式是通过竖井，它已经锈迹斑斑需要角磨机才能打开。我透过雨帘几乎看不见前面的黑色充气船。他们在那东西里会湿透的；我本来应该让 Orly 和我一起骑马——他爱陪着 Rowan——他像我们所有人一样感觉到了结束。在不久的将来，我们在 Shearwater 的共同生活将会结束。
- 关键词：shaft——竖井；rusted——锈迹斑斑；angle grinder——角磨机；curtain——帘；drenched——湿透；inflatable——充气的；senses——感觉到；ending——结束。
- 为什么这样写：用"drenched"建立 Dom 的"预感"——他"感觉"到结束。
- 读者视角提示：Dom 的"结束"是全书的"爱"主题——他"知道"要结束。
...
- 中文理解：我一直在为她发现 Hank 的那一天做准备。我不知道会是监禁的残酷还是我对她说的所有谎言，但其中一个会结束我们。我看到了她眼中的恐惧，感觉到了她的退缩。我知道它要来了，但我没有意识到它会感觉如此糟糕，如此毁灭性，我没有意识到这种痛苦无法准备。真他妈的可悲，要失去才知道爱的确切品质。
- 关键词：preparing——准备；ruthlessness——残酷；captivity——监禁；lies——谎言；horror——恐惧；retreat——退缩；ruinous——毁灭性；preparation——准备；precisely——确切地；quality——品质。
- 为什么这样写：用"ruinous"建立 Dom 的"毁灭"——他"知道"爱情被毁灭。
- 读者视角提示：Dom 的"失去"是全书的"爱"主题——他"知道"爱情的可贵。
...
- 中文理解：当我到达我们的海滩，把青蛙车开到沙滩上时，我能看见后面的反光红灯光，已经在半山腰了。我会让他们回来拿我船上的种子，而我去拿工具把那个混蛋弄出来。
- 关键词：reflective——反光的；already——已经；halfway——半山腰；straight——直接；tools——工具；son of a bitch——混蛋。
...
| 词/短语 | 释义 | 例句 |
|---------|------|------|
| fucker | 混蛋 | "I'd better not let the fucker drown" |
| drown | 淹死 | "let the fucker drown" |
| bear | 承受 | "I don't want her to bear the same loss" |
| ghost | 鬼魂 | "or meet his ghost" |
| violence | 暴力 | "the violence of it to scare" |
| rusted | 锈迹斑斑 | "rusted shut for many years" |
| angle grinder | 角磨机 | "require an angle grinder to open" |
| curtain | 帘 | "through the curtain of rain" |
| drenched | 湿透 | "They'll be drenched in that thing" |
| inflatable | 充气的 | "the black inflatable boat" |
| senses | 感觉到 | "he senses an ending" |
| ending | 结束 | "he senses an ending" |
...
| 词/短语 | 释义 | 例句 |
|---------|------|------|
| better | 最好 | "I decide I'd better not let" |
| right | 对 | "Rowan's right" |
| same | 同样的 | "the same loss I have" |
| carry | 背负 | "I don't want to carry his death" |
| death | 死亡 | "carry his death" |
| meet | 遇见 | "meet his ghost" |
| most | 最 | "Most of all" |
| scare | 惊吓 | "to scare my daughter" |
| already | 已经 | "any more than it already has" |
| way | 路 | "The only way back in" |
| dangerous | 危险 | "now that the vault is too dangerous" |
...
| more | 更 | "any more than it already has" |
| way | 路 | "The only way back in" |
| now | 现在 | "now that the vault is too dangerous" |
| only | 唯一 | "The only way back in" |
...
ch62 用 Dom 的"选择"建立全书的"父性"主题——他决定去救 Hank；他"不想"让 Rowan 承受失去亲人的痛苦；他"知道"他们的关系要结束了；他"去"救 Hank，因为他"选择"不杀人。
