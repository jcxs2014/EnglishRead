...
- **叙事手法**：Jonny 的 POV——他的内心独白和对 Moa 的观察。

## 精读

> **原句 1:** "Let this work. I want this."

- 中文理解：让这个能够 work。我想要这个。
- 关键词：Jonny 的 prayer；他的 vulnerability。
- 为什么这样写：Jonny 在祈祷——他想要这段 relationship 能够成功。这是一个 rare 的 vulnerable 时刻。
- 读者视角提示：Jonny 的内心独白显示了他对 personal happiness 的 desire。

---

> **原句 2:** "His desire to put Kim Ribbing behind bars suddenly seemed far, far away."
...
| 词汇 | 释义 | 例句 |
|------|------|------|
| intimacy | 亲密；亲密关系 | intimacy |
| priority | 优先；优先事项 | priority |
| vulnerability | 脆弱；易伤 | vulnerability |
...
Jonny 早上收到 Carmen 短信说 Rudbeck 物品已 secured，他回顾和 Moa 的夜晚，感到对抓捕 Kim 的 zeal 减弱，想要这段 relationship。
