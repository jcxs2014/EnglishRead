...
- **一句话概括**：客服地狱 28 天后终审开庭——Gideon 的判决不是刑罚而是复职：最后一颗浆果、最后一个任务，完成后「去往更好的地方」；他重写部门使命（We grant mercy. We show love.）并托她给 Harriet 带一只「音乐盒道歉」；她吃下浆果，笑得像哭。
- **视角**：第一人称 Darcy；终审判决章。
- **情感弧线位置**：钥匙转动——制度的善意浮出水面，结局的门号按响。
- **Tropes 兑现/反转**：兑现 paperwork hell 喜剧；反转——最坏的老板交出最软的底牌（We grant mercy）；final assignment 的悬念打包（任务＝她自己的渡越）。
- **人物弧线**：Darcy 与体制和解但不归顺（somewhere better 已被她用过）；Gideon 从反派滑向同病者（他也想 somewhere better）。
- **叙事手法**：客服窗口的地狱日常（microwaved fish）；1776 年积压文件的官僚史诗；浆果首尾呼应（ch01 求差事 → ch33 领「毕业」）。
...
| 词/短语 | 释义 | 例句 |
|---------|------|------|
| searing | 灼热的，强烈的 | I stare at her, stuck somewhere between disbelief and searing, startling affection. |
| deliverance | 解救，解脱 | And still not an inch closer to deliverance. |
| banished | 被放逐，被革除 | From this point forward, all paperwork is banished. |
| aplomb | 沉着，泰然自若 | the grace and aplomb of a drunk, sniveling beast |
| sniveling | 哭唧唧的，抽鼻子 | the grace and aplomb of a drunk, sniveling beast |
| cumbersome | 繁重累赘的，难对付的 | The mortal world is a cruel, cumbersome thing. |
| precariously | 摇摇欲坠地 | Every flat surface is occupied by a precariously leaning stack of files. |
| probation | 缓刑期，考察期 | Your probation has been completed. Congratulations. |
| reinstated | 复职，恢复原职 | You've been reinstated as a Reaper. |
| groveling | 卑躬屈膝，赔罪 | I believe the mortals call it groveling. |
| murky | 浑浊的，幽暗的 | holding on tight to the clues that drift lazily through the murky deep magic. |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句 |
|---------|------|------|
| cubicle | 小隔间，工位 | It's been twenty-eight days of agony in this tiny cubicle. |
| headset | 头戴式耳麦 | I stand and pull off my headset, tossing it on my desk with a clatter. |
| siloed | 被隔绝在筒仓里的（信息孤岛） | The Office of the Guardians is notoriously siloed from the rest of us |
| notoriously | 出了名地，众所周知地 | The Office of the Guardians is notoriously siloed from the rest of us |
| flourish | 花体一笔，夸张的划痕 | Gideon signs his name across the bottom of his document with a flourish and then slaps it on top of the closest pile. |
| smug | 自鸣得意的 | There's no need to be smug. |
| felled | 被放倒，击倒 | The fearsome Reaper, felled by intake forms. |
| tart | 酸的，尖酸的 | I toss the berry into my mouth, and I bite down on the tart fruit. |
| innocuous | 无害的，不起眼的 | I pluck the small, innocuous berry from its plush silk bed and hold it in the palm of my hand. |
| intake | 接收，登记（intake forms 入库表格） | The fearsome Reaper, felled by intake forms. |

### ⭐ 基础

| 词/短语 | 释义 | 例句 |
|---------|------|------|
| earpiece | 耳机（单耳） | I adjust my earpiece and jam my thumb into the button that flips the number above my head from 87 to 88. |
| fish | 鱼 | Someone did microwave fish," I reply. |
| shell | 空壳 | A shell of a being, scraping the very bottom of the barrel for any inkling of generosity. |
| globe | 球体（snow globe 雪花球） | In his hands, he holds a small wooden box, no bigger than a snow globe. |
| yew | 紫杉（树） | A bright red berry from the yew tree in the assignment room. |

## 一句话总结

客服窗口坐穿 28 天，终审的判决书却是复职通知——最后一颗浆果、一只待转交的音乐盒、一句「We grant mercy, we show love」；她咬下浆果，浮起的幻象让她笑得像哭：最后一单，通往她自己的 somewhere better。
