...
**为什么这样写：** Fia 的紧张反应暗示了她对 Glora 的不完全信任——Glora 是 Priest 的盟友，但 Fia 不确定 Glora 是否也是她的盟友。
...
**为什么这样写：** Nikolau 的外貌描写将他定位为 Fia 的对立面——他代表阳光与自由（金发的北方人），而她代表太阳（Raea 的候选人）与责任。他们的女儿 Miriel 是这两个世界的融合。
