...
**一句话概括：** Priest 接受了 Fia 的计划，开始招募盟友；与 Glora 的谈判揭示了 Inver 贵族政治的利益交换逻辑，Priest 用土地换忠诚，建立了他的第一个盟友。
...
**叙事手法：** 谈判场景的来回拉锯；对话作为权力博弈的主要工具；Glora 过去故事的片段揭示。
...
**中文理解：** "我有一些关系，"Priest 平铺直叙地说。"我在一些贵族中有些可以要求回报的人脉。但无法与 Lucian 抗衡，他收买了警卫，最高层级的 Inver 已经在策划如何夺取王位。"
...
**中文理解：** "你明白我不想要 Honoria 吗？"他说。"如果你们给我一个金盘子装着王位，并且能保证我在位时长寿、安逸和繁荣，我会拒绝吗？"
...
**句子结构：** 直接引语 + but there was admiration（语气转变）+ I always did like you best（承认欣赏）。

**关键词：** upstart bastard（暴发户私生子——侮辱与欣赏的混合）；make your own bid for the throne（自己争夺王位——Glora 立刻看穿 Priest 的意图）；I always did like you best（我向来最喜欢你——Glora 对 Priest 的真实态度）

**表达方式：** "upstart bastard"是 Glora 的典型风格——用侮辱来表达某种形式的尊重。

**为什么这样写：** Glora 的"admiration"是真实的——她认为 Priest 是唯一一个有胆量、有能力在当前乱局中采取行动的人。她一直喜欢他，这是她愿意与他合作的基础。
...
**句子结构：** Which bought him...定语从句 + And here I still stand（对比）+ while his body lies cooling（时间对比）。

**关键词：** paltry decade on the throne（可怜的十年——Priest 对 Orden 统治的评价）；his body lies cooling（尸体冷却——死亡的必然性）

**表达方式：** "here I still stand"与 Orden 的"尸体冷却"形成对比——Priest 活着而 Orden 死了。

**为什么这样写：** Priest 对 Orden 的评价是复杂的——他承认 Orden 赢了十年，但他也指出 Orden 最终失败了，而 Priest 还活着。这影响了 Glora 对他的看法。
...
**句子结构：** 直接引语 + I heard...的宾语从句。

**关键词：** How did you kill him（你怎么杀他的——Glora 直接问 Priest 是否杀了 Orden）；they can't sort out what（他们搞不清楚是什么——毒药类型未知）

**表达方式：** Glora 的问题直接而实际——她不关心道德，只关心事实。

**为什么这样写：** Glora 假设是 Priest 杀了 Orden——这符合 Inver 的逻辑（Priest 最有可能从中受益）。但 Priest 否认了。
...
**关键词：** married you when you were little more than a child（当你还是小孩子时娶了你——Glora 的童婚）；took over guardianship（接管监护权——Hadrian 的初步控制）；refuse to turn them over（拒绝归还——Glora 失去土地的根源）

**表达方式：** Priest 揭示了 Glora 过去的关键细节——她的土地被丈夫夺走，她被迫在宫廷中谋生。

**为什么这样写：** Priest 了解 Glora 的历史，这为他的提议（用土地换支持）提供了背景。他知道她失去过什么，这使他能够提供补偿。
...
**句子结构：** When she died... + 主句 with it's nothing like...but...的对比结构。

**关键词：** she left me her land（她把土地留给了我——Electa 留给 Priest 的遗产）；a few hundred acres on the eastern coast（东海岸几百英亩——Priest 即将提供给 Glora 的土地）

**表达方式：** Priest 用"nothing like what you lost"来降低他的提议——他知道这不是平等的交换，但他仍然提供它。

**为什么这样写：** Electa 留给 Priest 的土地成为 Priest 交易的筹码——他用它来换取 Glora 的支持。这显示 Priest 愿意放弃个人财产来获得盟友。
...
**句子结构：** I 'll accept this on one condition + With some indefinable emotion（语气）+ 两个破折号之间的解释性从句。

**关键词：** no direct heirs（没有直系继承人——三个人共有的特点）；When I die, I want the house and lands to revert to you（当我死时，我希望房子和土地归还给你——Glora 的条件）

**表达方式：** Glora 的条件是合理的——她接受土地，但要求它在她死后归还给 Priest。这显示了她的务实和对 Priest 计划的某种信任。

**为什么这样写：** Glora 接受 Priest 的提议，但附加了一个条件：土地最终归还给他。这意味着她不打算永远拥有它，而是用它来建立关系。
...
**句子结构：** 直接引语 + and for the first time（时间状语）+ There 's never been（双重否定）。

**关键词：** on your own behalf（为了你自己——Glora 确认 Priest 不打算自己成为国王）；There's never been an Inver regency（从来没有过 Inver 摄政——Glora 的评论）

**表达方式：** "her old disapproval"暗示 Glora 过去曾经不赞同 Priest 的某些选择——可能与他的生活方式或他与 Ariana 的关系有关。

**为什么这样写：** Glora 的问题揭示了她对 Priest 计划的最终怀疑——如果他不打算自己成为国王，他为什么要争夺摄政权？这是一个合理的问题。
...
**句子结构：** 独立感叹句 + Tyrus and his forefathers（Inver 的战神和先祖）。

**关键词：** Tyrus and his forefathers（Tyrus 和他的祖先——Inver 的宗教和政治传统）；how Tyrus and his forefathers must hate him（Tyrus 和他的祖先一定恨他——Priest 正在背叛 Inver 的传统）

**表达方式：** 叙述者的评论是全章的最后一笔——Priest 正在做的一切都与他作为 Inver Priest 的身份相悖。

**为什么这样写：** 这是全章最有力的结束语——Priest 正在背叛他为之服务的宗教和政治体系。他作为 Inver Priest 应该支持 Inver 传统，但他正在领导一场反对它的政变。

**段落逻辑：** Fia 和 Priest 达成协议 → Priest 正式开始招募盟友 → 他去见 Glora → 揭示 Glora 与 Hadrian 的历史 → Priest 提供 Electa 的土地作为交易 → Glora 接受但附加条件（死后归还）→ Priest 确认他不打算自己成为国王 → 计划开始执行。
...
Priest 在 Fia 的推动下正式入局，与 Glora 达成交易——用 Electa 遗留的土地换取她的支持，开始建立他的第一个联盟，以摄政王身份为 Justus 夺取王位。
