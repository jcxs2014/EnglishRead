...
- **一句话概括**：August 发现 Otta 用符记完全控制了一个 Weisanna；他们继续北上，Otta 准备对抗诸神
- **情感弧线位置**：低谷——August 意识到 Otta 的力量远超预期，他开始后悔唤醒她
- **Tropes 兑现/反转**：Otta's Control / March North / Regret / Power Display
- **人物弧线**：August 从"合作者"变为"被操纵者"——他意识到自己正在失去对局面的控制
...
**关键词**：no more agreements · not enough pieces · to go around

**为什么这样写**：用 "no more agreements"（不再有协议）和 "not enough pieces to go around"（没有足够的份额）暗示 Otta 的哲学——不是"谈判"，而是"征服"。她不是在与诸神共存，而是在与他们争夺资源。
...
原文第98行："August climbs astride his saddle" — 是的，"astride" 在原文中。
...
"barracks" 出现在第82行。
"trough" 出现在第83行。
"deserted" 出现在第90行（"the lack of greeting made it evident the place was deserted"）。
