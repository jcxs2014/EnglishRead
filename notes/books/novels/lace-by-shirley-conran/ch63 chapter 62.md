...
> **原句 1:** "I want to get an abortion."

- 中文理解："我想堕胎。"
- 关键词：I want to get an abortion — 六个词。
- 为什么这样写：句子只有六个词，却比她此后一生说过的任何话都干脆；`I want` 放在最前面，说明这不是求助，是决定。
- 读者视角提示：读者应该在这一行就明白，接下来三个月的努力，方向只有一个——让这个决定不成立。

> **原句 2:** "I'm not going to tell you who he was, so please don't ask me. There's a very good reason why I'm not going to tell you, but I'm not even going to tell you what it is."

- 中文理解："我不会告诉你们他是谁，所以请不要再问了。我不告诉你有一个很正当的理由，可我连那个理由是什么都不会说。"
- 关键词：please don't ask me / a very good reason / I'm not even going to tell you what it is — 三层封口。
- 为什么这样写：句子用两次 `I'm not going to tell` 构成一个套娃；`even` 一词说明她连"为什么保密"这条底线也守住了。
- 读者视角提示：读者应该在这里感受到，这个十七岁的女孩已经替所有人把真话拦在了门外。

> **原句 3:** "That's not possible, both my parents are dead," Judy heard herself say.
...
- 中文理解："如果是女孩，就叫 Elizabeth，跟我妈妈一样。如果是男孩，就叫 Nicholas。"
- 关键词：If it's a girl / it will be Elizabeth / If it's a boy / it will be Nicholas — 一组对称的假设。
- 为什么这样写：两个 `If` 结构完全对称；`after my mother` 和 Nick 的名字并列，让一个尚未出生的孩子同时挂上两个完全不同的来处。
- 读者视角提示：读者应该在这里明白，Lili 那个"从来只要一个名字"的执念，起点就在这个房间里。

> **原句 7:** "There was to be no attempt to deceive the child by telling him that Madame Dassin was the natural mother."

- 中文理解：不可以试图骗孩子，也就是说不能告诉他 Madame Dassin 是他的亲生母亲。
- 关键词：no attempt to deceive the child / telling him that Madame Dassin was the natural mother — 一个被否定的说法。
- 为什么这样写：句子用"不许这样说"的方式，把一条谎言的禁令留在档案里；`the natural mother` 这个法律术语让家庭会议带上了公证处的口气。
- 读者视角提示：读者应该在这一句里感到一种从未被提起过的重量——她们替孩子扛下了这个秘密，却没人问过孩子将来会不会想知道。

> **原句 8:** "A perfectly formed baby slipped out of her body and, with a whimper, little Elizabeth was born."
...
| 词/短语 | 释义 | 例句 |
|---|---|---|
| stilbestrol | 己烯雌酚 | "a phial of little pink capsules, stilbestrol" |
| impassive | 不动声色的 | "beckoned into the consulting room by the impassive nurse" |
| laconically | 简洁地 | "said the second nurse laconically" |
| proprietary | 独有的；家长式的 | "She felt a proprietary interest in the impending birth" |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句 |
|---|---|---|
| cervix | 宫颈 | "Your cervix isn’t completely dilated" |
| perineum | 会阴 | "You must let the perineum stretch naturally" |
| gaunt | 消瘦的 | "the rather gaunt, highly coloured face" |
| forlorn | 孤苦无依的 | "felt sorry for this small, forlorn blond child" |

### ⭐ 基础

| 词/短语 | 释义 | 例句 |
|---|---|---|
| ring | 戒指 | "Grandfather’s signet ring" |
| money | 钱 | "we should surely be able to raise the money for your medical bills" |
| baby | 婴儿 | "I don’t want to give my baby away" |
| birth | 出生 | "little Elizabeth was born" |
