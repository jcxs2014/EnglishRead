...
> **原句 1:** "Cruelty is finding pleasure in inflicting pain. I inflict pain only when it is necessary, and I don't find any pleasure in it."
...
> **原句 3:** "In two words—land theft."

- 中文理解：用两个词说清楚——土地被偷。
- 关键词：In two words / land theft — 两个词。
- 为什么这样写：他把一整段历史压进两个词；破折号让这个短语像一把刀，而不是一个解释。
- 读者视角提示：读者应该在这里明白，本章里没有真正的对话——他们争的是立场，不是彼此。
...
- 中文理解："问题在于，Abdi，你无法信任任何人——连我也不——而如果你不信任一个人，你就没法爱她。"
- 关键词：you can't trust anybody / not even me / you can't love someone if you don't trust her — 两个 `can't` 和一个条件句。
- 为什么这样写：句子用两个 `can't` 搭出一个逻辑台阶，最后一步落得毫无余地；`not even me` 三个字把"任何人"缩到了他们两个人之间。
- 读者视角提示：读者应该在这一句里听见全书的地基：爱在这个故事里从来不是一个结果，而是一次风险。

> **原句 7:** "You're right," said Lili, "I was." She was astonished to find herself using the past tense.

- 中文理解："你是对的，"Lili 说，"我曾经是。"她惊讶地发现自己用了过去时。
- 关键词：You're right / I was / using the past tense — 三个短语。
- 为什么这样写：句子的全部力量压在 `was` 一个词上；后半句由叙述者点破，让她自己都没察觉的那个时态成了整章的转折。
- 读者视角提示：读者应该在这里明白——她刚承认了自己在"靠爱来给人生赋予意义"，而他立刻抓住这句话反击。
...
| 词/短语 | 释义 | 例句 |
|---|---|---|
| sybaritic | 奢侈享乐的 | "This sybaritic life of love and luxury could not continue indefinitely" |
| infidel | 异教徒 | "She was an infidel" |
| ruthless | 无情的；不顾一切的 | "However, I am certainly ruthless" |
| unreserved | 毫无保留的 | "you cannot give me your unreserved love" |

### ⭐⭐ 进阶

| 词/短语 | 释义 | 例句 |
|---|---|---|
| concubine | 情妇 | "Lili was regarded as the concubine of the King" |
| harem | 后宫 | "A woman’s place was with the women, in the harem" |
| jodhpurs | 马裤 | "Lili, wearing jodhpurs and a white shirt" |
| mansef | 曼塞夫（贝都因宴席） | "Abdullah was about to attend a mansef in southern Sydon" |

### ⭐ 基础

| 词/短语 | 释义 | 例句 |
|---|---|---|
| trust | 信任 | "you can’t trust anybody—not even me" |
| love | 爱 | "you can’t love someone if you don’t trust her" |
| friend | 朋友 | "I most certainly will see my friends, Abdi" |
| sea | 海 | "ran away from him, along the lace-fringed, darkening sea" |

## 一句话总结

Chapter 57 让一个国王用"我不残忍，我只是无情"解释自己，又在同一个黄昏里用一场没有自控的粗鲁推翻这句话；两个人真正说清楚的只有一件事——他不敢再爱一次，因为她当年就是那个让他爱过一次又全部失去的人。
