...
句子结构：分号并列（not simple...; rather, it comprised...）+ 介词定语从句（in which... were confronting each other）。

关键词：labyrinthine layering / abstract dread / indebtedness

表达方式：用"maze / labyrinthine layering"把童年对神职的困惑空间化，奠定全篇"图书馆=迷宫"的母题。
...
句子结构：主句（I could almost read...）+ 同位语（sermons, of prayers and homilies）+ 定语从句（every one of which devoted...）+ 冒号主题（salvation through suffering）。

关键词：woodcut / sermons / salvation through suffering

表达方式：把图像读作文本（"read the woodcut"），木刻即宣教；末句点题"salvation through suffering"是全书核心母题。
...
句子结构：there be 存在句（an aura of legend）+ 同位（a cycle of... lore）+ 并列句（and I resolved that...）。

关键词：aura of legend / mute lore / closest attention

表达方式：把 Fr. Sevich 写成"活传说"，叙事者童年即被其神秘吸引，驱动后文偷页、追踪。
...
句子结构：主句（He soon became connected...）+ 同位并列（unarticulated narratives / stories in the rough / ones potentially epic）。

关键词：unarticulated narratives / stories in the rough / cosmic

表达方式：用"in the rough"（粗坯）暗示故事尚未成型却已宏大，把个人奇遇升格为宇宙神话。
...
句子结构：主句（one might surmise that）+ 双重 if 条件从句 + 结论（then those slender openings must have led to...）+ 现在分词（suggesting...）。

关键词：repository / athenaeum / bibliographic honeycomb

表达方式：用"honeycomb"（蜂巢）喻图书馆的无限格室，把知识储藏写成有机的、无尽的迷宫。
...
句子结构：过去分词状语（Not given back as it had been given）+ 主句（the law... is broken）+ 重复断裂的引语。

关键词：not given back / law of the book / broken

表达方式：亡魂话语破碎重复，像唱片卡顿；"law of the book"把偷页行为升格为宇宙法则的破坏。
...
句子结构：并列句（I felt that...）+ 宾语从句（what this lost soul had seen）。

关键词：lost soul / could see / same moment

表达方式：用"看见亡魂所见"完成叙事者与对象的认同，知识以恐怖视觉而非文字传递。
...
句子结构：同位双重（a visage grown rigid... / a visage petrified...），分词（grown rigid / petrified）作后置修饰。

关键词：visage / unimaginable horrors / petrified into spectral stone

表达方式：用"petrified into spectral stone"把恐惧写成材质转化，面容成碑。
...
句子结构：主句（I sprinkled...）+ 并列（it sizzled... and gave off...）+ 同位（an incense reeking of...）。

关键词：holy water / sizzled / secret denial and privilege

表达方式：圣水蚀书如酸，香气象征"被特权否认的秘密"，把宗教净化写成毁灭证据。
...
句子结构：简单主谓宾（I saw my own face）+ 现在分词伴随（smiling a smile of...）。

关键词：mirror / my own face / deep contentment

表达方式：以"满足的微笑"收尾，反差极大——他毁了圣物、逃避了命运，却感到圆满。
...
| athenaeum | 图书馆、文人会堂 | this fantastic athenaeum |
...
| priest | 教士 | the great priestly tribe |
| dream | 梦 | the dream at an end |
| face | 脸 | my own face smiling a smile of deep contentment |
| mirror | 镜 | In the mirror above the sink I saw my own face |

**一句话总结**：童年男孩偷走 Fr. Sevich 祈祷书的一页，借它窥见地底"拜占庭图书馆"与教士被书律处决的真相，最终以圣水毁证换回艺术的"真容"与一份令人发凉的满足。
